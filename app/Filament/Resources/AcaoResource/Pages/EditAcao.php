    ...
    protected function beforeSave(): void
    {
      //  dd($this->data['status']);
        if($this->data['status'] == 2)  {          
            ...
            $msg->to([$this->record->user->email, 'diex@garanhuns.ifpe.edu.br'])->subject('Proposta aprovada'); 
            ...
            $msg->to([$this->record->user->email, 'diex@garanhuns.ifpe.edu.br'])->subject('Proposta recusada'); 
