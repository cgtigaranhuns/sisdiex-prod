...
<body>
    ...
    <table>
        <tbody>
            <tr>
                <td>
                    <div class="card bg-body-tertiary" style="flex: 1; height: 10rem;">
                        <div class="card-body">
                            <h5 class="card-title" style="color: brown;">SISDIEX - ATÉ 2023 - GERAR E VALIDAR CERTIFICADOS</h5>
                            <p class="card-text">Gere e consulte os certificados de participação de curso ou evento até dezembro de 2023.</p>
